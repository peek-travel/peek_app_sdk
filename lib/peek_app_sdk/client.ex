defmodule PeekAppSDK.Client do
  ...
  defp api_url do
    case Application.get_env(:peek_app_sdk, :peek_api_env, :prod) do
      :prod -> "https://noreaga.peek.com/apps/backoffice-gql"
      :stage -> "https://noreaga.stage.peek.com/apps/backoffice-gql"
      :local -> "http://noreaga.peek.stack/apps/backoffice-gql"
    end
  end
end
